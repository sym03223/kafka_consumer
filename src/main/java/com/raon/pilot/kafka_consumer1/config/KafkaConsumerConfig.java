...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaConsumerProperty.getGroupId());
        config.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,kafkaConsumerProperty.getAutoOffsetReset());
